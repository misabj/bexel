...
export function DemoCta() {
  const t = useT();
  return (
    <section id="demo" className="bg-brand-900 py-24 dark:bg-ink-900">
      <div className="container-page">
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-800 to-brand-950 px-8 py-16 text-center shadow-card-hover dark:from-ink-800 dark:to-ink-950 sm:px-16"
        >
          <div
            aria-hidden
          ...
          <div className="relative mx-auto max-w-2xl">
            ...
            <p className="mt-4 text-lg text-slate-300">{t.demo.subtitle}</p>

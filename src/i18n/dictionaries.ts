...
const sr: Dictionary = {
  ...
  admin: {
    ...
    leads: {
      ...
      view: "Prikaži",
      delete: "Obriši",
      deleteTitle: "Brisanje lead-a",
      deleteConfirm: "Obrisati ovaj lead? Ova radnja se ne može poništiti.",
      deleted: "Lead obrisan.",
      deleteError: "Brisanje lead-a nije uspelo.",
      cancel: "Otkaži",
      showing: "Prikazano",
      of: "od",
      page: "Strana",
...
const de: Dictionary = {
  ...
  admin: {
    ...
    leads: {
      ...
      deleteConfirm: "Diesen Lead löschen? Diese Aktion kann nicht rückgängig gemacht werden.",
      deleted: "Lead gelöscht.",
      deleteError: "Löschen des Leads fehlgeschlagen.",
      cancel: "Abbrechen",
      showing: "Zeige",
      of: "von",
      page: "Seite",
...
const fr: Dictionary = {
  ...
  admin: {
    ...
    leads: {
      ...
      deleteConfirm: "Supprimer ce lead ? Cette action est irréversible.",
      deleted: "Lead supprimé.",
      deleteError: "Échec de la suppression du lead.",
      cancel: "Annuler",
      showing: "Affichage",
      of: "sur",
      page: "Page",
...
const sl: Dictionary = {
  ...
  admin: {
    ...
    leads: {
      ...
      delete: "Izbriši",
      deleteTitle: "Brisanje lead-a",
      deleteConfirm: "Izbrišem ta lead? Tega dejanja ni mogoče razveljaviti.",
      deleted: "Lead izbrisan.",
      deleteError: "Brisanje lead-a ni uspelo.",
      cancel: "Prekliči",
      showing: "Prikazano",
      of: "od",
      page: "Stran",
